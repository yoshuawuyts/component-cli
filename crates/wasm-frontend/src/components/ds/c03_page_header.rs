...
pub(crate) fn render() -> &'static str {
    r##"
    <section id="c-page-header" class="pt-12 md:pt-16">
      <div class="grid md:grid-cols-[200px_1fr] gap-6 md:gap-12">
        <div>
          <div class="text-[12px] mono uppercase tracking-wider text-ink-500">C03</div>
          <h2 class="mt-2 text-[24px] font-semibold tracking-tight">Page Header</h2>
          <p class="mt-2 text-[13px] text-ink-500 leading-relaxed">
            Top-of-page identification block: a kicker, a large title, an optional
            tagline, and an optional metadata strip. Used to anchor reference and
            documentation pages.
          </p>
        </div>
